...
class wso2is_km inherits wso2base {
  ...
  $enable_thrift_server = hiera('wso2::enable_thrift_server', 'true')
  $enable_jwt_generation = hiera('wso2::enable_jwt_generation', 'false')
  $enable_identity_governance = hiera('wso2::enable_identity_governance', 'true')
  $gateway_type = hiera('wso2::gateway_type', 'Synapse')
